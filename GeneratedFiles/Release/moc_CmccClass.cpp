...
QT_MOC_LITERAL(10, 122, 11), // "pawEditSlot"
QT_MOC_LITERAL(11, 134, 14), // "deleteUserSlot"
QT_MOC_LITERAL(12, 149, 9), // "loginSlot"
QT_MOC_LITERAL(13, 159, 10), // "logoutSlot"
QT_MOC_LITERAL(14, 170, 10), // "getsmsSlot"
QT_MOC_LITERAL(15, 181, 12) // "getVcodeSlot"

    },
    "CmccClass\0replyPageInfoSlot\0\0"
    "QNetworkReply*\0reply\0replyLoginSlot\0"
    "replyLogoutSlot\0replyVcodeSlot\0"
    "comboboxChangedSlot\0index\0pawEditSlot\0"
    "deleteUserSlot\0loginSlot\0logoutSlot\0"
    "getsmsSlot\0getVcodeSlot"
};
...
void CmccClass::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 5: _t->pawEditSlot((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 6: _t->deleteUserSlot(); break;
        case 7: _t->loginSlot(); break;
        case 8: _t->logoutSlot(); break;
        case 9: _t->getsmsSlot(); break;
        case 10: _t->getVcodeSlot(); break;
        default: ;
        }
    }
}
